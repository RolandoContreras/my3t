			...
			<div class="gallery-item photo hidden gallery-item-0">
                            ...
                            <style>.img-456 {background-color: #484848;}</style>	
                                    <span class="image-placeholder img-456" style="padding-bottom:56.18055556%">
                                        <img width="1440" height="809" class="lazyload" alt="" data-src="<?php echo site_url().'static/page_front/images/plan/presentacion/business.jpg'?>" data-srcset="<?php echo site_url().'static/page_front/images/plan/presentacion/business.jpg'?> 1440w, <?php echo site_url().'static/page_front/images/plan/presentacion/businessx300.jpg'?> 300w, <?php echo site_url().'static/page_front/images/plan/presentacion/businessx768.jpg'?> 768w, <?php echo site_url().'static/page_front/images/plan/presentacion/businessx1024.jpg'?> 1024w, <?php echo site_url().'static/page_front/images/plan/presentacion/businessx1116.jpg'?> 1116w, <?php echo site_url().'static/page_front/images/plan/presentacion/businessx806.jpg'?> 806w, <?php echo site_url().'static/page_front/images/plan/presentacion/businessx558.jpg'?> 558w, <?php echo site_url().'static/page_front/images/plan/presentacion/businessx655.jpg'?> 655w" data-sizes="(max-width: 1440px) 100vw, 1440px">	
                                    </span>
                                    <div class="caption">$1000</div>
			</div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">

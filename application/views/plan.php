            ...
            <div class="vc_column-inner ">
              <div class="wpb_wrapper">
                          ...
                          <div class="photo">
                            <a href="<?php echo site_url().'plan/basic';?>" class="item-link">
                              ...
                              <span class="image-placeholder img-456" style="padding-bottom:83.20610687%">
                                <img width="655" height="545" class="lazyload" alt="basic" data-src="<?php echo site_url().'static/page_front/images/plan/basic655.png';?>" data-srcset="" data-sizes="(max-width: 655px) 100vw, 655px">	
                              </span>
                        ...
                        <div class="item-box wow fadeIn">
                          <div class="photo">
                            <a href="<?php echo site_url().'plan/executive'?>" class="item-link">
                              <style>.img-456{background-color: #484848;}</style> 
                              <span class="image-placeholder img-456" style="padding-bottom:83.20610687%">
                                <img width="655" height="545" class="lazyload" alt="executive" data-src="<?php echo site_url().'static/page_front/images/plan/executive655.png';?>" data-srcset="" data-sizes="(max-width: 655px) 100vw, 655px">	
                              </span>
                        ...
                        <div class="item-box wow fadeIn">
                          <div class="photo">
                            <a href="<?php echo site_url().'plan/investor'?>" class="item-link">
                              <style>.img-456{background-color: #484848;}</style> 
                              <span class="image-placeholder img-456" style="padding-bottom:83.20610687%">
                                <img width="655" height="545" class="lazyload" alt="investor" data-src="<?php echo site_url().'static/page_front/images/plan/investor.jpg';?>" data-srcset="" data-sizes="(max-width: 655px) 100vw, 655px">	
                              </span>
				...
				<span class="custom-hover-icon">
                            ...
                            <div class="info">
                                <h3>
                                    ...
                                    <p class="terms"><a href="<?php echo site_url().'plan/investor'?>" data-term="beaches">$500</a></p>		
                            </div>
                        </div>
                      </div>
                        <!--END PACKAGE INVESTOR-->
                        ...
                        <div class="item-box wow fadeIn">
                          <div class="photo">
                            <a href="<?php echo site_url().'plan/business'?>" class="item-link">
                              <style>.img-456{background-color: #484848;}</style> 
                              <span class="image-placeholder img-456" style="padding-bottom:83.20610687%">
                                <img width="655" height="545" class="lazyload" alt="business" data-src="<?php echo site_url().'static/page_front/images/plan/business655.png';?>" data-srcset="" data-sizes="(max-width: 655px) 100vw, 655px">	
                              </span>
				...
				<span class="custom-hover-icon">
                            ...
                            <div class="info">
                                <h3>
                                    ...
                                    <p class="terms"><a href="<?php echo site_url().'plan/business'?>" data-term="beaches">$1000</a></p>		
                            </div>
                        </div>
                      </div>
                        <!--END PACKAGE BUSINESS-->
                        ...
                        <div class="item-box wow fadeIn">
                          <div class="photo">
                            <a href="<?php echo site_url().'plan/master'?>" class="item-link">
                              <style>.img-456{background-color: #484848;}</style> 
                              <span class="image-placeholder img-456" style="padding-bottom:83.20610687%">
                                <img width="655" height="545" class="lazyload" alt="master" data-src="<?php echo site_url().'static/page_front/images/plan/master655.png';?>" data-srcset="" data-sizes="(max-width: 655px) 100vw, 655px">	
                              </span>
				...
				<span class="custom-hover-icon">
                            ...
                            <div class="info">
                                <h3>
                                    ...
                                    <p class="terms"><a href="<?php echo site_url().'plan/master'?>" data-term="beaches">$1899</a></p>		
                            </div>
                        </div>
                      </div>
                        <!--END PACKAGE MASTER-->
                        <!--START PACKAGE APERTURA-->
                      <div class="portfolio-item portfolio-item-type-3 has-padding w4 post-435 portfolio type-portfolio status-publish has-post-thumbnail hentry portfolio_category-beaches" data-portfolio-item-id="435" data-terms="beaches">
                        <div class="item-box wow fadeIn">
                          <div class="photo">
                            <a href="<?php echo site_url().'plan/apertura'?>" class="item-link">
                              <style>.img-456{background-color: #484848;}</style> 
                              <span class="image-placeholder img-456" style="padding-bottom:83.20610687%">
                                <img width="655" height="545" class="lazyload" alt="apertura" data-src="<?php echo site_url().'static/page_front/images/plan/apertura.jpg';?>" data-srcset="" data-sizes="(max-width: 655px) 100vw, 655px">	
                              </span>
				...
				<span class="custom-hover-icon">
                            ...
                            <div class="info">
                                <h3>
                                    <a href="<?php echo site_url().'plan/apertura'?>" class="item-link">APERTURA PRE LANZAMIENTO</a>
                                </h3>
                                    <p class="terms"><a href="<?php echo site_url().'plan/apertura'?>" data-term="beaches">$299</a></p>		
                            </div>
                        </div>
                      </div>
                        <!--END PACKAGE APERTURA-->
                    </div>
                    <script type="text/javascript">

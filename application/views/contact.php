...
<body class="page-template-default page page-id-12 wpb-js-composer js-comp-ver-5.3 vc_responsive header-absolute">
  ...
  <div class="wrapper" id="main-wrapper">
    <style>
      header.site-header {padding-top: 35px;}
    </style>
    <style>
      header.site-header {padding-bottom: 35px;}
    </style>
    <!--START HEADER 2-->
    <?php $this->load->view("header_2");?>
    <!--END HEADER 2-->
    <script>
      var headerOptions = headerOptions || {};Object.assign( headerOptions, {"stickyHeader":false} );
    </script>
          ...
          <div class="wpb_column vc_column_container vc_col-sm-12">
            <div class="vc_column-inner ">
              <div class="wpb_wrapper">
                ...
                <script>
                  var labVcMaps = labVcMaps || [];labVcMaps.push({id: 'el_59e451473d203',locations: [{"marker_image":"<?php echo site_url().'static/page_front/icon/pin-2.png';?>","retina_marker":"yes","latitude":"-12.1416088","longitude":"-76.99181550000003","marker_title":"3T Lima","marker_description":"<p>Av. La Encalada # 1171,<br \/>\nMonterrico - Santiago de surco,<br \/>\nLima - Perú<\/p>\n<p><b>Horario de Trabajo:<\/b><br \/>\Lunes \u2014 Viernes (08:00 \u2014 17:00)<br \/>\nSabados (09:00 \u2014 15:00)<\/p>\n","marker_image_size":[128,128]}],zoom: 6,scrollwheel: false,dropPins: true,panBy: [0,0],tilt: 0,heading: 0,mapType: 'roadmap',panControl: false,zoomControl: true,mapTypeControl: false,scaleControl: false,streetViewControl: false,overviewMapControl: false,plusMinusZoom: false,styles: [ { "elementType": "geometry.stroke", "stylers": [ { "visibility": "off" } ] }, { "elementType": "labels.icon", "stylers": [ { "visibility": "off" } ] }, { "elementType": "labels.text.fill", "stylers": [ { "color": "#65afdd" }, { "lightness": 50 }, { "weight": 2 } ] }, { "elementType": "labels.text.stroke", "stylers": [ { "visibility": "off" } ] }, { "featureType": "administrative.country", "elementType": "geometry.stroke", "stylers": [ { "color": "#0052a0" }, { "visibility": "on" }, { "weight": 1.5 } ] }, { "featureType": "administrative.country", "elementType": "labels.text", "stylers": [ { "visibility": "off" } ] }, { "featureType": "administrative.province", "elementType": "labels.text", "stylers": [ { "visibility": "off" } ] }, { "featureType": "landscape", "elementType": "geometry.fill", "stylers": [ { "hue": "#0074b9" }, { "saturation": 59 }, { "lightness": -42 } ] }, { "featureType": "landscape.natural.terrain", "stylers": [ { "visibility": "off" } ] }, { "featureType": "landscape.natural.terrain", "elementType": "geometry.fill", "stylers": [ { "visibility": "off" } ] }, { "featureType": "poi", "stylers": [ { "visibility": "off" } ] }, { "featureType": "road", "elementType": "geometry.fill", "stylers": [ { "color": "#0078b9" }, { "saturation": -29 }, { "lightness": 30 } ] }, { "featureType": "transit", "elementType": "geometry.fill", "stylers": [ { "color": "#65afdd" }, { "lightness": 10 } ] }, { "featureType": "water", "elementType": "geometry.fill", "stylers": [ { "color": "#0052a0" } ] }, { "featureType": "water", "elementType": "labels.text.fill", "stylers": [ { "color": "#65afdd" } ] }]});
                </script>
              </div>
            </div>
          </div>
        ...
        <div class="vc_row wpb_row vc_row-fluid services-row">
            ...
            <div class="vc_column-inner">
              <div class="wpb_wrapper">
                <div class="wpb_single_image wpb_content_element vc_align_center retina-icon">
                  <figure class="wpb_wrapper vc_figure"> <img width="128" height="128" src="<?php echo site_url().'static/page_front/icon/marcador.png';?>" class="vc_single_image-img attachment-full"
                      alt="paquete" /> </figure>
                </div>
          ...
          <div class="service-box wpb_column vc_column_container vc_col-sm-3 vc_col-xs-6">
            <div class="vc_column-inner ">
              <div class="wpb_wrapper">
                <div class="wpb_single_image wpb_content_element vc_align_center retina-icon">
                  <figure class="wpb_wrapper vc_figure"> <img width="128" height="128" src="<?php echo site_url().'static/page_front/icon/mapa.png';?>" class="vc_single_image-img attachment-full"
                      alt="paquete" /> </figure>
                </div>
                <div class="wpb_text_column wpb_content_element post-formatting ">
                  <div class="wpb_wrapper">
          ...
          <div class="service-box wpb_column vc_column_container vc_col-sm-3 vc_col-xs-6">
            <div class="vc_column-inner">
              <div class="wpb_wrapper">
                <div class="wpb_single_image wpb_content_element vc_align_center retina-icon">
                  <figure class="wpb_wrapper vc_figure"> <img width="128" height="128" src="<?php echo site_url().'static/page_front/icon/avion.png';?>" class="vc_single_image-img attachment-full"
                      alt="productos" /> </figure>
                </div>
                <div class="wpb_text_column wpb_content_element post-formatting ">
                  <div class="wpb_wrapper">
          ...
          <div class="service-box wpb_column vc_column_container vc_col-sm-3 vc_col-xs-6">
            <div class="vc_column-inner">
              <div class="wpb_wrapper">
                <div class="wpb_single_image wpb_content_element vc_align_center retina-icon">
                  <figure class="wpb_wrapper vc_figure"> <img src="<?php echo site_url().'static/page_front/icon/moneda.png';?>" alt="resultados" /> </figure>
                </div>
                <div class="wpb_text_column wpb_content_element post-formatting ">
                  <div class="wpb_wrapper">
                    ...
                    <div class="wpb_column vc_column_container vc_col-sm-3">
                      <div class="vc_column-inner">
                        <div class="wpb_wrapper">
                          <div class="wpb_text_column wpb_content_element post-formatting ">
                            <div class="wpb_wrapper">
                            <p><span style="color: #222222;"><strong><?=lang('idioma.contact_visitanos');?></strong></span></p>
                            <p><?=lang('idioma.contact_calle');?></p>
                            <p><?=lang('idioma.contact_edificio');?></p>
                            <p>San Isidro - Lima, Perú</p>
                            <p>&nbsp;</p>
                            <p><span style="color: #222222;"><strong><?=lang('idioma.contact_horario');?></strong>:</span></p>
                            <p><?=lang('idioma.contact_lunes');?> (<span style="color: #222222;"><strong>09:00 — 18:00</strong></span>)</p>
                            <p><?=lang('idioma.contact_sabado');?> (<span style="color: #222222;"><strong>09:00 — 16:00</strong></span>)</p>
                            </div>
                          </div>
                        </div>
                      </div>
...
$(document).ready(function() {
    $("#formid").validate({
        ...
        messages: {
            name: "<?=lang('idioma.ingrese_nombre');?>",
            email : "<?=lang('idioma.ingrese_email');?>",
            subject: "<?=lang('idioma.ingrese_asunto');?>",
  ...
  <script>
    /* <![CDATA[ */var google_conversion_id = 991533214;var google_custom_params = window.google_tag_params;var google_remarketing_only = true;/* ]]> */
  </script>
  <script src="//www.googleadservices.com/pagead/conversion.js"></script>
  <style>
    iframe[name="google_conversion_frame"] { position: absolute; left: -99999px; }
  </style>
</body>

<section>
    <div class="section-heading row">
        <div class=" col-lg-9 col-md-8 col-sm-7 col-xs-12">
            <h1 class="title text-uppercase">GLOBAL PASS</h1>
        </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="row">
				    ...
				    <div class="panel panel-default">
						...
						<div class="panel-body"> 
							<p>
                                                            <img src="<?php echo site_url().'static/backoffice/images/globalpass_internacional.jpg';?>" alt="Global Pass Internacional"/>
                                                        </p>
						</div> 
					</div> 
				</div>
					...
					<div class="panel panel-default">
						<div class="panel-heading clearfix"> 
                                                    <div class="panel-title"><b>GLOBAL PASS INTERNACIONAL</b></div> 
						</div> 
						<!-- panel body --> 
						<div class="panel-body"> 
                                                    <p>¡400,000 Hoteles y Resorts, con las mejores marcas en las que confías! 8,000 ubicaciones de alquiler de autos en todo el país incluyendo precios comparativos. Resorts de 8 días y 7 noches en destinos de todo el mundo. Miles de actividades y excursiones para agregar a sus vacaciones. Todo esto y más podrás encontrar en nuestra plataforma y con hasta 70% de descuento. Con el paquete Investor accedes a $500 PASS y con el paquete Business accedes a $1000 PASS para descuentos.</p><br/>
                                                    <a href="http://www.globalpassinternacional.com/" target="_blank"><button class="btn btn-success btn-block" type="button">IR</button></a>
						</div> 
					</div> 
				</div>
                    </div>

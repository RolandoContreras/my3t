<section>
    <div class="section-heading row">
        <div class=" col-lg-9 col-md-8 col-sm-7 col-xs-12">
            <h1 class="title text-uppercase"><?=lang('idioma.b_unilevel');?></h1>
        </div>
                        ...
                        <div class="panel panel-default network-tree-panel">
                           <div class="cont-arbol">
                               <div class="alert alert-inverse pull-left" style="opacity: 0.7;" aria-label="Right Align">
                                   <a href="<?php echo site_url().'backoffice/unilevel';?>"><button class="btn btn-success btn-outline" type="button"><?=lang('idioma.b_voler_inicio');?></button></a>
                                   <a href="javascript:history.back(1)"><button class="btn btn-success btn-outline" type="button"><?=lang('idioma.b_volver_atras');?></button></a>
                               </div>
                               <div class="alert alert-inverse pull-right" style="opacity: 0.7;" aria-label="Right Align">
                                   <button class="btn btn-success btn-outline" type="button"><?=lang('idioma.b_directos');?> <?php echo $obj_customer->direct;?></button><br/><br/>
                                   <button class="btn btn-success btn-outline" type="button"><?=lang('idioma.b_2_directos');?> <?php echo isset($direct_3)?$direct_3:"0";?></button><br/><br/>
                                   <button class="btn btn-success btn-outline" type="button"><?=lang('idioma.b_3_directos');?> <?php echo isset($direct_4)?$direct_4:"0";?></button>
                                </div>
                                            ...
                                            <div class="popover__wrapper">
                                                      ...
                                                      <div class="push popover__content">
                                                          <p class="popover__message">
                                                              ...
                                                              <?=lang('idioma.b_estado');?> <span class="<?php echo $style;?>"><?php echo $text;?></span><br/>
                                                              <?=lang('idioma.b_rango');?> <b><?php echo string_to_mayusculas($obj_customer->rango);?></b><br/>
                                     ...
                                     foreach ($obj_customer_n2 as $value) { ?>
                                        <li>
                                            <div class="popover__wrapper">
                                                      ...
                                                      <div class="push popover__content">
                                                          <p class="popover__message">
                                                              <?=lang('idioma.b_uni_usuario');?> <b><?php echo string_to_mayusculas($value->username);?></b><br/>
                                                              <?=lang('idioma.b_uni_nombre');?> <b><?php echo string_to_mayusculas($value->first_name." ".$value->last_name);?></b><br/>
                                                              <?=lang('idioma.b_estado');?> <span class="<?php echo $style;?>"><?php echo $text;?></span><br/>
                                                              <?=lang('idioma.b_rango');?> <b><?php echo string_to_mayusculas($value->rango);?></b><br/>
                                                                        ...
                                                                        <?php if($value->customer_id == $value3->parents_id){ ?>
                                                                                <li>
                                                                                    <div class="popover__wrapper">
                                                                                          ...
                                                                                          <div class="push popover__content">
                                                                                              <p class="popover__message">
                                                                                                  <?=lang('idioma.b_uni_usuario');?> <b><?php echo string_to_mayusculas($value3->username);?></b><br/>
                                                                                                  <?=lang('idioma.b_uni_nombre');?> <b><?php echo string_to_mayusculas($value3->first_name." ".$value3->last_name);?></b><br/>
                                                                                                  <?=lang('idioma.b_estado');?> <span class="<?php echo $style;?>"><?php echo $text;?></span><br/>
                                                                                                  <?=lang('idioma.b_rango');?> <b><?php echo string_to_mayusculas($value3->rango);?></b><br/>
                                                                                                        ...
                                                                                                        <?php if($value3->customer_id == $value4->parents_id){ ?>
                                                                                                                <li>
                                                                                                                    <div class="popover__wrapper">
                                                                                                                      ...
                                                                                                                      <div class="push popover__content">
                                                                                                                          <p class="popover__message">
                                                                                                                              <?=lang('idioma.b_uni_usuario');?> <b><?php echo string_to_mayusculas($value4->username);?></b><br/>
                                                                                                                              <?=lang('idioma.b_uni_nombre');?> <b><?php echo string_to_mayusculas($value4->first_name." ".$value4->last_name);?></b><br/>
                                                                                                                              <?=lang('idioma.b_estado');?> <span class="<?php echo $style;?>"><?php echo $text;?></span><br/>
                                                                                                                              <?=lang('idioma.b_rango');?> <b><?php echo string_to_mayusculas($value4->rango);?></b><br/>

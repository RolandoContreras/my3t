...
<section>
    <div class="section-heading row">
        <div class=" col-lg-9 col-md-8 col-sm-7 col-xs-12">
            <h1 class="title text-uppercase"><?=lang('idioma.b_tablero');?></h1>
        </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="well media media-badges box-height box">
                            ...
                            <h5 class="media-heading text-uppercase title-small"><?=lang('idioma.b_total_pagado');?></h5>
                    ...
                    <div class="col-sm-6">
                        <div class="well media media-badges box-height box">
                            <div class="media-body media-middle">
                            <h5 class="media-heading text-uppercase title-small"><?=lang('idioma.b_balance_disponer');?></h5>
            ...
            <div class="col-lg-6">
                ...
                <div class="row">
                    <div class="col-sm-8">
                            ...
                            <div class="media-body media-middle">
                            <h5 class="media-heading text-uppercase title-small"><?=lang('idioma.b_paquete_actual');?></h5>
                ...
                <div class="panel-body">
                    <div class="flex-container fix-box-height">
                        <a class="col-flex box-height">
                            <div class="media">
                                <div class="media-body media-middle">
                                    <h5 class="media-heading"><?=lang('idioma.b_rango_actual');?></h5>
                        ...
                        <a class="col-flex box-height">
                            <div class="media">
                                <div class="media-body media-middle">
                                    <h5 class="media-heading"><?=lang('idioma.b_proximo_rango');?></h5>
                        ...
                        <a class="col-flex box-height">
                            <div class="media">
                                <div class="media-body media-middle">
                                <h5 class="media-heading"><?=lang('idioma.b_puntaje_izquierda');?></h5>
                        ...
                        <a class="col-flex box-height">
                            <div class="media">
                                <div class="media-body media-middle">
                                <h5 class="media-heading"><?=lang('idioma.b_puntaje_derecha');?></h5>
                        ...
                        <a href="<?php echo site_url().'backoffice/binary';?>" class="col-flex box-height">
                            <div class="media">
                                <div class="media-body media-middle">
                                    <h5 class="media-heading"><?=lang('idioma.b_h_binario');?></h5>
                        ...
                        <a href="<?php echo site_url('backoffice/points');?>" class="col-flex box-height">
                            <div class="media">
                                <div class="media-body media-middle">
                                    <h5 class="media-heading"><?=lang('idioma.b_puntos_mes');?></h5>
                        ...
                        <a href="<?php echo site_url('backoffice/unilevel');?>" class="col-flex box-height">
                            <div class="media">
                                <div class="media-body media-middle">
                                <h5 class="media-heading"><?=lang('idioma.b_patrocinio_directos');?></h5>
                        ...
                        <a href="javascript:void(0);" class="col-flex box-height">
                            <div class="media">
                                <div class="media-body media-middle">
                                <h5 class="media-heading"><?=lang('idioma.b_team_builder');?></h5>
                        ...
                        <a href="<?php echo site_url('backoffice/misdatos');?>" class="col-flex box-height">
                            <div class="media">
                                <div class="media-body media-middle">
                                    <h5 class="media-heading"><?=lang('idioma.b_fecha_activacion');?></h5>
                        ...
                        <a href="<?php echo site_url('backoffice/misdatos');?>" class="col-flex box-height">
                            <div class="media">
                                <div class="media-body media-middle">
                                    <h5 class="media-heading"><?=lang('idioma.b_fecha_creacion');?></h5>
                        ...
                        <a href="#" class="col-flex box-height">
                            <div class="media">
                                <div class="media-body media-middle">
                                    <h5 class="media-heading"><?=lang('idioma.b_catalogo');?></h5>
                                <button class="btn btn-success" type="button"><?=lang('idioma.b_ver');?></button>
                                </div>
                                <div class="media-right media-middle">
        ...
        <div class="col-md-12">
            <div class="panel panel-success">
                <div class="panel-collapse collapse in center">
                        <div class="panel-heading clearfix"> 
                        <div class="panel-title"><b><?=lang('idioma.b_seleccionar_paquete');?></b></div> 
                    </div> 
                    <!-- panel body --> 
                    <div class="panel-body"> 
    ...
    <!--PAKAGE SELECTED-->
        <div class="col-md-12"> 
            <div class="panel panel-success">
                    <div id="collapse_message" class="panel-collapse collapse in center">
                        <div class="panel-heading clearfix"> 
                            <div class="panel-title"><b><?=lang('idioma.b_cuenta_seleccionada');?></b></div> 
                        </div>
                        <div class="col-md-3"> 
                            <div class="panel panel-success">
                                <!-- panel body --> 
                        ...
                        <div class="col-md-7"> 
                            <div class="panel panel-success">
                                <div id="collapse_message" class="panel-collapse collapse in center">
                                    <div class="panel-heading clearfix"> 
                                            <div class="panel-title"><b><?=lang('idioma.b_modo_activacion');?></b></div> 
                                    </div> 
                                    <!-- panel body --> 
                                    <div class="panel-body"> 
                                        <p><strong><?=lang('idioma.b_activacion_btc');?></strong> <?=lang('idioma.b_enviar_monto');?><b><a><?php echo "$".$obj_customer->price;?></a></b>  <?=lang('idioma.b_siguiente_direccion');?> <b>15UuH4uF42kFEHL7uZbibjDhGJ5YTZjewn</b><br/> <?=lang('idioma.b_enviar_mensaje');?><br></p><br/>
                                        <div class="bs-example">
                                             <a href="<?php echo site_url().'backoffice/message_confirmation';?>"><button type="button" class="btn btn-black btn-block"><i class="fa fa-upload"></i>&nbsp;&nbsp;<span class="bold"><?=lang('idioma.b_mensaje_confirmacion');?></span></button></a>
                                        </div>
                                    </div> 
                                </div>
                            </div> 
    ...
    <!--LINK OF SPONSOR-->
            ...
            <div class="panel panel-success">
                    <div id="collapse_message" class="panel-collapse collapse in center">
                        <div class="panel-heading clearfix"> 
                            <div class="panel-title"><b><?=lang('idioma.b_patrocinio');?></b></div> 
                        </div>
                        <div class="col-md-3"> 
                            <div class="panel panel-success">
                                <!-- panel body --> 
                        ...
                        <div class="col-md-9"> 
                            <div class="panel panel-success">
                                <div id="collapse_message" class="panel-collapse collapse in center">
                                    <div class="panel-heading clearfix"> 
                                            <div class="panel-title"><b><?=lang('idioma.b_link_patrocinio');?></b></div> 
                                    </div> 
                                    <!-- panel body --> 
                                    <div class="panel-body"> 
                                        <p><?=lang('idioma.b_estimado_usuario');?> <br>•	<?=lang('idioma.b_h_link_patrocinio');?> <a href="<?php echo site_url().'register/afiliate/'.str_to_minuscula($obj_customer->username);?>" class="alert-link" target="_blank"><?php echo site_url().'register/afiliate/'.str_to_minuscula($obj_customer->username);?></a><br><?=lang('idioma.b_compartiendo_enlace');?><br><b><?=lang('idioma.b_activar_patrocinados');?></b><br>•	<?=lang('idioma.b_las_activaciones');?> <b>15UuH4uF42kFEHL7uZbibjDhGJ5YTZjewn</b></p>
                                        <br/>

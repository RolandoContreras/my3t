...
class message_masive_model_atributos{	
    var $message_masive_id='';
    var $title='';
    var $content='';
    var $img='';
    var $active='';
...
class Message_masive_Model extends CI_Model{ 

    public function __construct() {
        parent::__construct();  
        $this->table = 'message_masive';
	$this->table_id = 'message_masive_id';
        $this->message_masive_id='';
        $this->title='';
        $this->content='';
        $this->img='';
        $this->active='';
	$this->status_value='';
        ...
        $this->updated_at='';
        $this->updated_by='';
	$this->fields = new message_masive_model_atributos();
    }   
